...
TestU.analyse =function (value){
	...
	*/
	try{
		var hasChildren=false,type,sConstructor="缩主内部对象",summary;
	...
	*/
	if(!inited){
		...
		var html=[
			...
			'<ul><li>',
				'当前察看的对象:<input id="ST_var" ><button>察看</button><button>加入观测树</button><br/>',
				'<div id="ST_msg"></div>',
			'</li><li>',
				'运行代码:<button>运行以下textarea里的代码</button><br/>',
